    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          right: 0,
          zIndex: 20,
          background: boxColor ?? 'var(--color-accent)',
          borderRadius: 4,
        }}
      />
    </section>
...
const Ripple = memo(function Ripple({
  ...
  return (
    <section
      className={cn(
        'max-w-[50%] absolute inset-0 flex items-center justify-center dark:bg-white/5 bg-neutral-50 [mask-image:linear-gradient(to_bottom,black,transparent)] dark:[mask-image:linear-gradient(to_bottom,white,transparent)]',
        className
      )}
    >
...
const AnimatedForm = memo(function AnimatedForm({
  ...
  const gridCols = fieldPerRow === 2 ? 'md:grid-cols-2' : 'md:grid-cols-1'
  ...
  return (
    <section className="max-md:w-full flex flex-col gap-4 w-96 mx-auto">
      ...
      <form onSubmit={handleSubmit}>
        <section className={cn('grid grid-cols-1 mb-4 gap-2', gridCols)}>
          {fields.map((field) => (
    ...
    <div className="flex max-lg:justify-center w-full md:w-auto">
      <div className="w-full lg:w-1/2 h-[100dvh] flex flex-col justify-center items-center max-lg:px-[10%]">
        <AnimatedForm
          ...
          goTo={goTo}
          googleLogin={formFields.googleLogin}
        />
      </div>
    </div>
  )
